...
const SearchAreaTwo = ({}: //   handleBathroomChange,
//   handleBedroomChange,
//   handleSearchChange,
//   handlePriceChange,
//   maxPrice,
...
any) => {
  ...
  return (
    <>
      <div
        className="inner-banner-two inner-banner z-1 pt-170 xl-pt-150 md-pt-130 pb-20 xl-pb-80 md-pb-50 position-relative"
        style={{
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6">
              <div className="title-one text-white mb-30 md-mb-20">
                <h3>
                  Find Your{' '}
                  <span>
                    Office Space{' '}
            ...
            <div className="col-lg-6">
              <p className="sub-heading">
                Over 100 listings, office, space and many more available now!
              </p>
            </div>
          </div>
