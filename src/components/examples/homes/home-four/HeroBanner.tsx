        ...
        <Slider {...setting} className="hero-slider-one m0">
          <div className="item m0">
            <div
              className="hero-img"
              style={{
                backgroundImage: `url(/assets/images/media/img_32.jpg)`,
              }}
            ></div>
          </div>
          <div className="item m0">
            <div
              className="hero-img"
              style={{
                backgroundImage: `url(/assets/images/media/img_27.jpg)`,
              }}
            ></div>
          </div>
          <div className="item m0">
            <div
              className="hero-img"
              style={{
                backgroundImage: `url(/assets/images/media/img_28.jpg)`,
              }}
            ></div>
          </div>
        </Slider>
          ...
          <div className="row">
            <div className="col-lg-6 wow fadeInLeft">
              <div className="mt-45">
                ...
                <p className="fs-24 text-white pt-40 pb-30 md-pb-20 pe-xl-5">
                  Explore a vast selection of over 745,000 listings, including
                  apartments, lots, and plots.
                </p>
                <div className="d-inline-flex flex-wrap align-items-center">
                  <Link
                    href="/listing_01"
                    className="btn-two rounded-0 border-0 mt-15 me-4"
                  >
