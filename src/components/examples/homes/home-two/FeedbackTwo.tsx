...
import BrandOne from "@/components/examples/common/brand/BrandOne";
...
const feedback_data: DataType[] = [
  {
    ...
    desc: (
      <>
        &quot;Excellent service, made my dream home real.{" "}
        <span>highly recommended</span> real estate agency!&quot;
      </>
    ),
    title: "Musa Delimuza",
    country: "Milan, Italy",
