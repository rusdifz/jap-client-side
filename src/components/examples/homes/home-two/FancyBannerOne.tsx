...
import FaqOne from "@/components/examples/common/faq/FaqOne";
            ...
            <div className="col-xl-8 col-lg-9 ms-auto wow fadeInRight">
              <div className="ps-xxl-5">
                <div className="title-one mb-50 lg-mb-30">
                  <h2 className="font-garamond fs-xl">
                    Best homes, perfect Match for you.
                  </h2>
                </div>
                <div className="row">
                  <div className="col-lg-4">
                    <Image
                      src={fancyImg_1}
                      alt=""
                      className="lazy-img ms-auto d-none d-lg-block me-auto mt-20"
                    />
                  </div>
                  <div className="col-lg-8">
                    <p className="fs-24 color-dark">
                      We’ve more than 745,000 apartments & home for sell, rent &
                      mortgage.
                    </p>
                    <div
                      className="accordion accordion-style-one mt-60"
                      id="accordionOne"
                    >
                      <FaqOne />
                    </div>
