...
import DropdownFive from "@/components/examples/search-dropdown/home-dropdown/DropdownFive";
          ...
          <div className="row">
            <div className="col-lg-7">
              <div className="position-relative z-1">
                <h1 className="hero-heading font-garamond wow fadeInUp mb-50">
                ...
                <div className="row">
                  <div className="col-xl-7 col-lg-12 col-md-7">
                    <p
                      ...
                      data-wow-delay="0.1s"
                    >
                      Over 745,000 listings, apartments, lots & plots available
                      now
                    </p>
                  </div>
                  <div className="col-xl-5 col-lg-12 col-md-5">
                    <div className="d-flex flex-column justify-content-center align-items-start">
                      ...
                      <p className="m0 pt-10 rating">
                        <span className="fw-500 color-dark">13k rating</span>{" "}
                        (4.7 Rating)
                      </p>
                    </div>
                  </div>
