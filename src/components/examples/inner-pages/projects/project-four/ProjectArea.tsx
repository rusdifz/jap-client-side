...
const Fancybox = dynamic(
  () => import("@/components/examples/common/Fancybox"),
  {
    ssr: false,
  }
);
      ...
      <div className="container">
        <div className="filter-nav-one style-two border-line d-lg-flex align-items-center justify-content-between">
          <ul className="style-none d-flex justify-content-center flex-wrap isotop-menu-wrapper">
            ...
            <li
              className={selectedFilter === "apartments" ? "is-checked" : ""}
              onClick={handleFilterKeyChange("apartments")}
            >
              Apartments
            </li>
            <li
              className={selectedFilter === "house" ? "is-checked" : ""}
              onClick={handleFilterKeyChange("house")}
            >
              House
            </li>
            <li
              className={selectedFilter === "villa" ? "is-checked" : ""}
              onClick={handleFilterKeyChange("villa")}
            >
              VILLA
            </li>
            <li
              className={selectedFilter === "flat" ? "is-checked" : ""}
              onClick={handleFilterKeyChange("flat")}
            >
              FLAT
            </li>
          </ul>
        ...
        <div
          ...
          className="isotop-gallery-wrapper grid-1column pt-40 lg-pt-30"
        >
          <div className="grid-sizer"></div>
          {project_data
            .filter((items) => items.page === "project_4")
            .map((item) => (
              <div
                key={item.id}
                className={`isotop-item house flat ${item.category}`}
              >
                  ...
                  <div className="row gx-xxl-5 align-items-center">
                      ...
                      <figure className="image-wrapper position-relative z-1 overflow-hidden">
                        ...
                        >
                          <a
                            ...
                            href={`/assets/images/project/img_${item.fancybox}.jpg`}
                          >
                            <Image
                              src={item.thumb}
                              alt=""
                    ...
                    <div className="col-lg-6 ms-auto">
                      <div className="caption ps-xxl-5">
                        ...
                        <h3>
                          <Link href="/project_details_01">{item.title}</Link>
                        </h3>
                        <p className="fs-24 pt-45 lg-pt-30 md-pt-10 pb-50 lg-pb-30 md-pb-10">
                          {item.desc}
                        </p>
                        <Link
                          href="/project_details_01"
