...
const feature_content: ContentType = {
  ...
  desc_2: (
    <>
      Our founders Dustin Moskovitz & Justin Rosenstein met leading Engineering
      teams at Facebook. As operations scaled, they grew frustrated by how
      difficult coordinate
    </>
  ),
  desc_3: (
    <>
