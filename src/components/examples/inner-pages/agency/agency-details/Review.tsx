...
const review_data: DataType[] = [
  {
    ...
    desc: (
      <>
        Lorem ipsum dolor sit amet consectetur. Pellentesque sed nulla facili
        diam posuere aliquam suscipit quam.
      </>
    ),
  },
  {
...
const Review = ({ style }: any) => {
  ...
  const displayedReviews = showAllReviews
    ? review_data
    : review_data.slice(0, maxReviewsToShow);
            ...
            <div className="text">
              <div className="d-sm-flex justify-content-between">
                ...
                <ul className="rating style-none d-flex xs-mt-10">
                  <li>
                    <span className="fst-italic me-2">{item.total_rating}</span>{" "}
                  </li>
