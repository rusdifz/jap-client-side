...
import service_data from '@/libs/static-content/service-data';
          ...
          {service_data.map((item) => (
            ...
            >
              <div className="card-style-ten d-flex align-items-start flex-column w-100 h-100">
                ...
                <h6>{item.title}</h6>
                <p>{item.desc}</p>
                {/* <Link href="/service_details" className="btn-twelve sm mt-auto">
                  {item.btn}
                </Link> */}
              </div>
            </div>
